...
contract FreedomConvoy is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6790819656 * 10**18;//6790819656
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Freedom convoy";
    ...
    address public ownerAddress = address(0x08EAD158B92b472C0a7a1Fe01087EA6d432d46e9);// receive 50% totalSupply
    address public devAddress = address(0xB08aB3600e4c1EacF6869a367024D5b02C860e29);// market addr
    address public foundAddress = address(0x1806E5c24336Eb20b785cB5F9219193ca5d985D6);
    address public lpReceiver = address(0xd7f30821A178DC1522EeddD1779674fE6Fdc8121);

    address public managerAddress = address(0x6fA4ecCa5C99B578610204529901151d264B385c);// receive 50% totalSupply

    address public busdtToken = 0x55d398326f99059fF775485246999027B3197955;
    ...
    uint256 private numTokensSellToAddToLiquidity = 3395409828 * 10**15;//0.05% rTotal
    ...
    constructor () public {
        _decimals = 18;
        _rOwned[ownerAddress] = _rTotal/2;// receive 50% totalSupply
        _rOwned[managerAddress] = _rTotal/2;// receive 50% totalSupply
        ...
        emit Transfer(address(0), ownerAddress, _tTotal/2);
        emit Transfer(address(0), managerAddress, _tTotal/2);
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        _takeDev(sender, tDev/3);
        _takeFound(sender, tDev-tDev/3);
    ...
    function setNumTokensSellToAddToLiquidity(uint256 _newValue) public onlyOwner {
    ...
    function swapTokensForDividendToken(uint256 tokenAmount) private {
        if (tokenAmount > 0) {
            ...
            uint256 dividends = IERC20(busdtToken).balanceOf(address(this));
            IERC20(busdtToken).transfer(address(devAddress), dividends);
        }
    }
}
